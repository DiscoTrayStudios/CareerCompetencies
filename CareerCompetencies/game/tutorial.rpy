label Tutorial:
    ...
    e "The purpose of this game is to give you, the player, an insight into what a generalized life at Hendrix can be like, with an emphasis on career development."
